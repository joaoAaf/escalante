package br.com.appsemaperreio.escalante_api.seguranca.config.custom_exceptions;
...
public class AuthenticationEntryPointCustom implements AuthenticationEntryPoint {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(AuthenticationEntryPointCustom.class);
